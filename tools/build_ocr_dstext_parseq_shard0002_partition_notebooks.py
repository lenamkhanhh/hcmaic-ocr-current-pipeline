"""Build deterministic full-execution partitions for OCR shard 0002.
...
ownership settings while preserving shard-0002 provenance in generated cells.
"""
...
GLOBAL_SHARD_FRAME_COUNT = 24_926
PARTITION_COUNT = 3
PARTITION_STRATEGY = "sorted_frame_uid_round_robin"
REVIEW_FRAME_COUNT = 12

PARTITION_SPECS = [
    {"index": 0, "owner": "REPLACE_WITH_KAGGLE_OWNER", "name": "hcmaic-ocr-dstext-parseq-s0002-part0-t4x2-20260820"},
    {"index": 1, "owner": "REPLACE_WITH_KAGGLE_OWNER", "name": "hcmaic-ocr-dstext-parseq-s0002-part1-t4x2-20260820"},
    {"index": 2, "owner": "REPLACE_WITH_KAGGLE_OWNER", "name": "hcmaic-ocr-dstext-parseq-s0002-part2-t4x2-20260820"},
]
